  ...
  return (
    <footer className="bg-gray-900">
      <div className="mx-auto max-w-7xl px-6 pt-16 pb-8 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="space-y-8">
            ...
            <p className="text-xs text-gray-500">
              {ECOSYSTEM.matrix.stats.customers} clientes \u00b7{" "}
              {ECOSYSTEM.matrix.stats.yearsInBusiness}+ a\u00f1os
            </p>
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-10 md:mt-0">
                <h3 className="text-sm/6 font-semibold text-white">Conectar</h3>
                <ul role="list" className="mt-6 space-y-4">
                  {NAVIGATION.social.map((item) => (
                    <li key={item.name}>
                      <a
        ...
        {/* Copyright - Obligatorio: "Hecho por Ronaldo Paulino" */}
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-sm/6 text-gray-400">
            &copy; {new Date().getFullYear()} {ECOSYSTEM.techDivision.name}.
            Hecho por{" "}
            <a
